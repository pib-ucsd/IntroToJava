...
ds_map_add(global.answers, inst_6A16CDEE,  ["numAirAttacks + 1 < MAX_AIR_ATTACKS", "numAirAttacks < MAX_AIR_ATTACKS - 1"]);
ds_map_add(global.answers, inst_3350E6A3,  ["damage += airStrength * numAttacks;", "damage += numAttacks * airStrength;"]);
...
ds_map_add(global.answers, inst_34B18E37,  ["numAttacks += 8;", "numAttacks = numAttacks + 8"]);
